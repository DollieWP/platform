/*PSK*/pml_version_cb(/*PSK*/
{
	...
	"messages"    : {
        "20161214" : "<p>Hi folks!</p><p>Life has been really complicated this last year but I hope things will be fun again and I hope I will have time to update Log Viewer.</p>",
        "20141121" : "Thank you to people who have starred the project on GitHub !",
		"20141012" : "<p>Hi folks!</p><p>This alert box has been added to send important messages to you about <em>Log Viewer</em>. It is not intended to be a <em>Spam Zone</em>.</p><p>I need to know if I should continue the development of <em>Log Viewer</em> and how many people are interested in <em>Log Viewer</em>. Would you just let me know by starring the project in GitHub please?</p><p><iframe src=\"http://logviewer.com/github-btn.html?user=potsky&repo=PimpMyLog&type=watch&count=true\" allowtransparency=\"true\" frameborder=\"0\" scrolling=\"0\" width=\"170\" height=\"30\"></iframe></p><p>And don&#8217;t worry, <em>Log Viewer</em> will be in open-source forever.</p><p><em>potsky</em></p>",
	...
	"changelog"   : {
        "1.7.14" : {
            ...
            "fixed" : [
                ...
                "Undefined index: logs (<a href=\"http://support.logviewer.com/discussions/problems/162-undefined-index-logs\" target=\"_blank\">more info</a>)"
            ]
        },
        "1.7.13" : {
            "released" : "2017-02-23",
        ...
        "1.7.11" : {
            ...
            "fixed" : [
                "BUG: fseek() expects parameter 2 to be integer, float given (<a href=\"http://support.logviewer.com/discussions/problems/150-bug-fseek-expects-parameter-2-to-be-integer-float-given\" target=\"_blank\">more info</a> and #108)"
            ]
        },
		"1.7.10" : {
			"released" : "2015-11-24",
			"fixed" : [
				"Regex tester error in debugger for authenticated users (<a href=\"http://support.logviewer.com/discussions/problems/75-bug-on-debugger\" target=\"_blank\">more info</a>)"
			]
		},
		"1.7.9" : {
			"released" : "2015-05-27",
		...
		"1.7.6" : {
			...
			"fixed" : [
				"Configuration : max, refresh and notifiy parameters was no more optional since Log Viewer 1.6"
			]
		},
		"1.7.5" : {
			"released" : "2014-12-03",
			...
			"fixed" : [
				"Bug with the open_basedir ini parameter set with non composer installations (<a href=\"http://support.logviewer.com/discussions/problems/68-trouble-with-alias\" target=\"_blank\">more info</a>)"
			],
			"changed" : [
		...
		"1.7.2" : {
			...
			"new" : [
				...
				"Enable the SAFE_MODE latch file to let users run Log Viewer on ultra secured PHP installations (<a href=\"http://support.logviewer.com/kb/configuration/php-installations-with-suhosin-extension-and-exotic-ini-settings\" target=\"_blank\">more info</a>)"
			],
			"changed" : [
				"Glob files are now considered as unique for user access"
			],
			"fixed" : [
				"Fix the user management popup in Firefox (<a href=\"http://support.logviewer.com/discussions/suggestions/57-ihm-for-addupdate-logifile-to-scan\" target=\"_blank\">more info</a>)"
			]
		},
		"1.7.1" : {
			"released" : "2014-11-23",
		...
		"1.5.2" : {
			...
			"changed" : [
				...
				"Add log timezone support by default (<a href=\"http://support.logviewer.com/discussions/questions/33-date-with-timezone\" target=\"_blank\">more info</a>)"
			]
		},
		"1.5.1" : {
			"released" : "2014-11-14",
		...
		"1.5.0" : {
			...
			"new"      : [
				...
				"Feature #61 : Authentication (Take a look <a href=\"http://support.logviewer.com/kb/configuration/enable-authentication-on-already-installed-instances\">here to enable authentication</a> on an existing instance)",
				...
				"New global parameter <code>SORT_LOG_FILES</code> to sort your log files in the log selector on top left. Documentation is <a href=\"http://logviewer.com/documentation/configuration.html#SORT_LOG_FILES\">here</a>.",
		...
		"1.3.0" : {
			"released" : "2014-10-12",
			"new"      : [
				"Configuration file can be splitted in several files in subfolder <code>config.user.d</code>. Documentation is <a href=\"http://logviewer.com/documentation/configuration.html#USER_CONFIGURATION_DIR\">here</a>. (#62)",
		...
		"1.0.1" : {
			"released" : "2014-01-30",
			"changed" : [
				"Add a link in the upgrade message to the Log Viewer upgrade documentation #56"
			],
			"new" : [
				...
				"Now clicking on the logo will reload Log Viewer with default user settings",
		...
		"0.9.9" : {
			...
			"new" : [
				...
				"Add a copy to clipboard action when configuring Log Viewer",
		...
		"0.9.0" : {
			"notice" : "First public pre-release of Log Viewer!",
			"released" : "2013-12-22"
		}
	}
}
