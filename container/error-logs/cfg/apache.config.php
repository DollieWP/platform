...
function apache_load_software() {
	return array(
		'name'    => __t('Apache'),
		'desc'    => __t('Apache Hypertext Transfer Protocol Server'),
		'home'    => __t('http://httpd.apache.org'),
		'notes'   => __t('All versions 2.x are supported.'),
...
function apache_get_config( $type , $file , $software , $counter ) {
	...
	if ( $type == 'error' ) {
		...
		$remain = 10;
		$test   = 0;
		error_log( 'Log Viewer has been successfully configured with Apache' );
