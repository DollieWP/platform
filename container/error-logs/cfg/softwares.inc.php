...
$softwares_all[ 'my_software' ] = array(
	'name' => __t('My Super Software'),
	'desc' => __t('My Super Software build with love for you users which are installing Log Viewer !'),
	'home' => __t('http://www.example.com'),
	'note' => __t('All versions 2.x are supported but 1.x too in fact.'),
);
