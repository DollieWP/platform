...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
	"globals": {
		...
		"_remove_me_to_set_FOOTER"                      : "&copy; <a href=\"http:\/\/www.potsky.com\" target=\"doc\">Potsky<\/a> 2007-' . YEAR . ' - <a href=\"http:\/\/logviewer.com\" target=\"doc\">Log Viewer<\/a>",
		...
		"_remove_me_to_set_PIMPMYLOG_VERSION_URL"       : "http:\/\/demo.logviewer.com\/version.js",
		...
		"_remove_me_to_set_TITLE"                       : "Log Viewer",
		"_remove_me_to_set_TITLE_FILE"                  : "Log Viewer [%f]",
		"_remove_me_to_set_UPGRADE_MANUALLY_URL"        : "http:\/\/logviewer.com\/getting-started\/#update",
